...
export default <Default className="nds-tabs_default nds-tabs_default-vpl" />;
...
export let states = [
  {
    ...
    element: (
      <Default
        className="nds-tabs_default nds-tabs_default-vpl"
        selectedIndex={1}
      />
    )
  }
...
export let examples = [
  {
    ...
    element: <Overflowing className="nds-tabs_default nds-tabs_default-vpl" />
  }
];
