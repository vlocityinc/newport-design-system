...
export let Scroller = props => (
  <div className="nds-tabs__nav-scroller nds-has-overflow">
    <div className="nds-tabs__nav-scroller_inner">{props.children}</div>
  </div>
);
...
export let states = [
  {
    ...
    label: 'Default',
    element: (
      <div className="nds-tabs_default">
        <Scroller>
          <ul className="nds-tabs_default__nav" role="tablist">
            <li
              className="nds-tabs_default__item nds-text-title_caps nds-active"
              title="Item One"
              role="presentation"
            >
              <a
                className="nds-tabs_default__link"
            ...
            <li
              className="nds-tabs_default__item nds-text-title_caps"
              title="Item Two"
              role="presentation"
            >
              <a
          ...
          <div className="nds-tab__scroll-controls">
            <ButtonIcon
  ...
  },
  {
    ...
    label: 'Scoped',
    element: (
      <div className="nds-tabs_scoped">
        <Scroller>
          <ul className="nds-tabs_scoped__nav" role="tablist">
            <li
              className="nds-tabs_scoped__item nds-text-title_caps nds-active"
              title="Item One"
              role="presentation"
            >
              <a
                className="nds-tabs_scoped__link"
                href="javascript:void(0);"
                role="tab"
                tabIndex="0"
                aria-selected="true"
            ...
            <li
              className="nds-tabs_scoped__item nds-text-title_caps"
              title="Item Two"
              role="presentation"
            >
              <a
        ...
        <div
          id="tab-scoped-1"
          className="nds-tabs_scoped__content nds-show"
          role="tabpanel"
        ...
        <div
          id="tab-scoped-2"
          className="nds-tabs_scoped__content nds-hide"
          role="tabpanel"
