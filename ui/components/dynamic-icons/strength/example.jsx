...
let Strength = props => (
  <span
    ...
    className={classNames('nds-icon-strength', props.className)}
  >
...
// Default
export default <Strength data-nds-strength="0" />;
...
export let states = [
  {
    id: 'strength-1',
    label: 'Strength: 1',
    element: <Strength data-nds-strength="1" />
  },
  {
    id: 'strength-2',
    label: 'Strength: 2',
    element: <Strength data-nds-strength="2" />
  },
  {
    id: 'strength-3',
    label: 'Strength: 3',
    element: <Strength data-nds-strength="3" />
  },
  {
  ...
  },
  {
    ...
    element: <Strength className="nds-is-animated" data-nds-strength="3" />
  },
  {
