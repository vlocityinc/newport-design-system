...
export let RichTextEditor = props => (
  <div
    ...
    className={classNames(
      'nds-rich-text-editor nds-form-element nds-grid nds-grid_vertical nds-nowrap',
      props.className
    )}
  >
    {props.children}
...
export let RteToolbar = props => (
  <div
    ...
    className={classNames(
      'nds-rich-text-editor__toolbar nds-shrink-none',
      props.className
    )}
  >
    {props.children}
...
export let RteFormatFont = props => (
  ...
  >
    <div className="nds-rich-text-editor__select">
      <ComboboxContainer
        className="nds-size_x-small"
        id="font-family"
        inputIcon="right"
  ...
  <ButtonGroupList aria-label="Format background & text color">
    <li>
      <button
        tabIndex="-1"
        disabled={props.disabledButtons}
        className="nds-button nds-button_icon nds-button_icon-more nds-button_icon-more-filled"
        aria-haspopup="true"
      >
        <SvgIcon
        ...
        <SvgIcon
          ...
          symbol="down"
        />
        <span className="nds-assistive-text">Background Color</span>
      </button>
    </li>
    ...
    <li>
      ...
      >
        ...
        <SvgIcon
          ...
          symbol="down"
        />
        <span className="nds-assistive-text">Text Color</span>
      </button>
    </li>
  </ButtonGroupList>
);
...
export let RteTextarea = props => (
  <div className="nds-rich-text-editor__textarea nds-grid">
    {props.text ? (
      <div
        ...
        className="nds-rich-text-area__content nds-grow"
      >
        {props.text}
      </div>
    ) : (
      <div
        ...
        contentEditable={!props.disabled ? 'true' : null}
        suppressContentEditableWarning
        className="nds-rich-text-area__content nds-text-color_weak nds-grow"
      >
        {props.placeholder}
      </div>
    )}
...
export let states = [
  {
    ...
    element: (
      <Demo>
        <RichTextEditor className="nds-has-focus">
          <RteToolbar>
            <RteFormatText tabIndexSetting="0" />
            <RteFormatBody />
            <RteClearFormatting />
  ...
  },
  {
    ...
    element: (
      <Demo>
        <RichTextEditor className="nds-has-error">
          <RteToolbar>
            <RteFormatText tabIndexSetting="0" />
            <RteFormatBody />
            <RteClearFormatting />
          ...
          <div
            id="rte-error-01"
            className="nds-form-element__help nds-p-around_small"
          >
    ...
    element: (
      <Demo>
        <RichTextEditor>
          ...
          <RteToolbar className="nds-rich-text-editor__toolbar_bottom">
            <RteFormatText tabIndexSetting="0" />
            <RteFormatBody />
            <RteClearFormatting />
          </RteToolbar>
