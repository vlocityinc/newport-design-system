...
export let ActivityTimelineItem = props => (
  <div className="nds-timeline__item">
    <span className="nds-assistive-text">Event</span>
    <MediaObject
      figureRight={
        <TimelineActions
    ...
    >
      <MediaObject
        className="nds-timeline__media nds-timeline__media_event"
        figureLeft={<TimelineIcon symbol="event" />}
        figureLeftClassName="nds-timeline__icon"
      >
        <h3 className="nds-truncate" title="Company One — EBC Meeting">
        ...
        <ul className="nds-list_horizontal nds-wrap">
          <li className="nds-m-right_large">
            <span className="nds-text-title">Time:</span>
          ...
          <li className="nds-m-right_large">
            <span className="nds-text-title">Location:</span>
            <span className="nds-text-body_small">
