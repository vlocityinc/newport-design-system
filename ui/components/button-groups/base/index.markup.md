If the last button is wrapped in another element (for example, a `div` holding a dropdown menu), place the `.nds-button_last` class on the wrapping element instead.
