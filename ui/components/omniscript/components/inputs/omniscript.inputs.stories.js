...
storiesOf(`${base}`.replace(/(^\/)|(\/$)/g, ''), module)
  ...
  .add('File', () => {
    return '<p>File stories coming soon...</p>';
  })
  .add('Image', () => {
    return '<p>Image stories coming soon...</p>';
  })
  .add('Lookup', () => {
  ...
  .add('Number', () => {
    return '<p>Number stories coming soon...</p>';
  })
  .add('Password', () => {
    return '<p>Password stories coming soon...</p>';
  })
  .add('Radio', () => {
    return '<p>Radio stories coming soon...</p>';
  })
  .add('Range', () => {
    return '<p>Range stories coming soon...</p>';
  })
  .add('Select', () => {
    return '<p>Select stories coming soon...</p>';
  })
  .add('Telephone', () => {
    return '<p>Telephone stories coming soon...</p>';
  })
  .add('Text', () => {
  ...
  .add('Text Area', () => {
    return '<p>Text Area stories coming soon...</p>';
  })
  .add('Time', () => {
    return '<p>Time stories coming soon...</p>';
  })
  .add('URL', () => {
    return '<p>URL stories coming soon...</p>';
  });
