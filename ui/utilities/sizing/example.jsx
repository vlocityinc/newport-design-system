...
let SizePreviewExample = props => (
  <div className={`nds-size_${props.size}`}>
    <div className="nds-box nds-box_x-small nds-text-align_center nds-m-around_x-small">
      .nds-size_{props.size}
    </div>
  </div>
);
...
export let examples = [
  {
    ...
    label: '2 Column Span',
    element: (
      <div className="demo-only demo-only--sizing nds-grid nds-wrap">
