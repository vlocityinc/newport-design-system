...
export let examples = [
  {
    ...
    element: <Text className="nds-text-body_regular" />,
    description:
  ...
  },
  {
    ...
    element: <Text className="nds-text-body_small" />,
    description:
  ...
  },
  {
    ...
    element: <Text className="nds-text-heading_large" />
  },
  {
    id: 'heading-medium',
    label: 'Heading size - Medium',
    element: <Text className="nds-text-heading_medium" />
  },
  {
    id: 'heading-small',
    label: 'Heading size - Small',
    element: <Text className="nds-text-heading_small" />
  },
  {
    id: 'heading-title',
    label: 'Title',
    element: <Text className="nds-text-title" />
  },
  {
    id: 'heading-title--caps',
    label: 'Title uppercase',
    element: <Text className="nds-text-title_caps" />
  },
  {
    id: 'longform',
    label: 'Longform',
    element: (
      <div className="nds-text-longform">
        ...
        <p>The quick brown fox jumps over the lazy dog.</p>
        <h3 className="nds-text-heading_small">Heading</h3>
        <ul>
  ...
  },
  {
    id: 'align-left',
    label: 'Align left',
    element: <Text className="nds-text-align_left" />,
    description:
  ...
  },
  {
    id: 'align-right',
    label: 'Align right',
    element: <Text className="nds-text-align_right" />,
    description:
      'These helpers align text to the left, right, or center. Note that this is not used for layout and is only for aligning text horizontally.'
  },
  {
    id: 'align-center',
    label: 'Align center',
    element: <Text className="nds-text-align_center" />,
    description:
      'These helpers align text to the left, right, or center. Note that this is not used for layout and is only for aligning text horizontally.'
  },
  {
    ...
    label: 'Color - Default',
    element: <Text className="nds-text-color_default" />
  },
  {
    id: 'text-color-weak',
    label: 'Color - Weak',
    element: <Text className="nds-text-color_weak" />
  },
  {
    id: 'text-color-error',
    label: 'Color - Error',
    element: <Text className="nds-text-color_error" />
  },
  {
    ...
    element: (
      ...
      >
        <Text className="nds-text-color_inverse" />
      </div>
    )
  },
  {
    ...
    element: (
      <div
        ...
        style={{ padding: '0.5rem', background: '#16325c' }}
      >
        <Text className="nds-text-color_inverse-weak" />
      </div>
    )
  }
];
