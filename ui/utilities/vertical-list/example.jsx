...
export let examples = [
  ...
  },
  {
    ...
    label: 'Block links',
    element: (
      <ul className="nds-has-block-links">
        <li>
  ...
  },
  {
    ...
    element: (
      <ul className="nds-has-block-links_space">
        <li>
  ...
  },
  {
    ...
    element: (
      <ul className="nds-has-inline-block-links">
        <li>
          <a href="javascript:void(0);">
  ...
  },
  {
    ...
    element: (
      <ul className="nds-has-inline-block-links_space">
        <li>
          <a href="javascript:void(0);">
  ...
  },
  {
    ...
    label: 'Top',
    element: (
      <ul className="nds-has-dividers_top">
        <li className="nds-item">List item with top divider</li>
  ...
  },
  {
    ...
    element: (
      <ul className="nds-has-dividers_top-space">
        <li className="nds-item">List item with top divider with space</li>
        <li className="nds-item">List Item</li>
        <li className="nds-item">List Item</li>
      </ul>
    )
  },
  {
    ...
    label: 'Top with link',
    element: (
      <ul className="nds-has-dividers_top nds-has-block-links">
  ...
  },
  {
    ...
    element: (
      <ul className="nds-has-dividers_top nds-has-block-links_space">
        <li className="nds-item">
          <a href="javascript:void(0);">List item with link and top divider</a>
        </li>
        <li className="nds-item">
  ...
  },
  {
    ...
    label: 'Bottom',
    element: (
      <ul className="nds-has-dividers_bottom">
        <li className="nds-item">List item with bottom divider</li>
        <li className="nds-item">List Item</li>
        <li className="nds-item">List Item</li>
      </ul>
    )
  },
  {
    ...
    element: (
      <ul className="nds-has-dividers_bottom-space">
        <li className="nds-item">List item with bottom divider with space</li>
        <li className="nds-item">List Item</li>
        <li className="nds-item">List Item</li>
      </ul>
    )
  },
  {
    ...
    element: (
      <ul className="nds-has-dividers_bottom nds-has-block-links">
        <li className="nds-item">
          <a href="javascript:void(0);">
  ...
  },
  {
    ...
    element: (
      <ul className="nds-has-dividers_bottom nds-has-block-links_space">
        <li className="nds-item">
          <a href="javascript:void(0);">
  ...
  },
  {
    ...
    label: 'Around',
    element: (
      <ul className="nds-has-dividers_around">
        <li className="nds-item">List item with around divider</li>
        <li className="nds-item">List Item</li>
        <li className="nds-item">List Item</li>
      </ul>
    )
  },
  {
    ...
    element: (
      <ul className="nds-has-dividers_around-space">
        <li className="nds-item">List item with around divider with space</li>
        <li className="nds-item">List Item</li>
        <li className="nds-item">List Item</li>
      </ul>
    )
  },
  {
    ...
    element: (
      <ul className="nds-has-dividers_around nds-has-block-links">
        <li className="nds-item">
          <a href="javascript:void(0);">
  ...
  },
  {
    ...
    element: (
      <ul className="nds-has-dividers_around nds-has-block-links_space">
        <li className="nds-item">
          <a href="javascript:void(0);">
