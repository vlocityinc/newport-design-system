...
describe('modelUtils', () => {
    ...
    describe('test getting selectable elements functionality', () => {
        let flowModel = {};
        ...
        it('When no element is selectable for getFirstSelectableElementGuid', () => {
        ...
        it('When no element is selectable when using getFirstSelectableAncestorOrSiblingGuid', () => {
            const selectableGuid = getFirstSelectableAncestorOrSiblingGuid(flowModel, { guid: 's2' });
            expect(selectableGuid).toBeUndefined();
        });

        it('When there is a selectable ancestor', () => {
            setIsSelectableToTrue('s1');
            setIsSelectableToTrue('d1');
            const selectableGuid = getFirstSelectableAncestorOrSiblingGuid(flowModel, { guid: 's2' });
            expect(selectableGuid).toEqual('s1');
        });

        it('When there are no selectable ancestors, use an sibling', () => {
            setIsSelectableToTrue('s3');
            const selectableGuid = getFirstSelectableAncestorOrSiblingGuid(flowModel, { guid: 'd2' });
            expect(selectableGuid).toEqual('s3');
        });
    });
});
