...
export const flowWithAllElementsUIModel = {
  elements: {
      ...
      inputParameters: [
        {
          ...
          name: "SObjectRowId",
          value: "787fd564-24db-448c-ba59-ef88c8a5cbd9.Id",
          valueDataType: "reference"
        }
      ],
      outputParameters: [],
      ...
      assignmentItems: [
        {
          ...
          leftHandSide: "8573e2d4-ccfb-4701-be66-e38b54ba7375",
          rightHandSide: "e62ce284-ccf2-46af-8446-c0a110a4bba0",
    ...
    "e12af1ed-86ee-4f2f-8de8-9dc3cc64dca1": {
      ...
      outcomeReferences: [
        {
          outcomeReference: "3f1c4d9a-ea88-4c6c-85ac-6aa009601964"
        }
      ],
      ...
      availableConnections: [
        {
          type: "REGULAR",
          childReference: "3f1c4d9a-ea88-4c6c-85ac-6aa009601964"
        },
        {
          type: "DEFAULT"
        }
    ...
    "ba8a8e41-3944-4099-9655-065f054e811f": {
      ...
      text: "<p>Hello {!8573e2d4-ccfb-4701-be66-e38b54ba7375}</p>",
      dataType: "String"
    },
    "4afdbe2b-6b5a-4da3-887d-5b755f53b64e": {
      ...
      object: "Account",
      objectIndex: "97a7048c-7323-4356-93c4-30995cf2c8c7",
      filterType: "none",
      filters: [
        {
      ...
      outputReferenceIndex: "9b2579d0-01d3-45b0-b6b2-bb016b085511",
      dataType: "SObject",
      isCollection: false,
      subtype: "Account",
      storeOutputAutomatically: true,
    ...
    "48cb0159-3cde-48ad-9877-644e3cc4b5e9": {
      ...
      object: "Account",
      objectIndex: "f35bd1d9-bafd-4fc9-b682-2d2557f8f796",
      filterType: "none",
      filters: [
        {
          rowIndex: "e5b4998c-a36e-407f-afb7-2301eda53b8d",
          leftHandSide: "",
          rightHandSide: "",
          rightHandSideDataType: "",
          operator: ""
      ...
      queriedFields: [
        {
          field: "Id",
          rowIndex: "7bbacaec-c6f9-4188-9af4-a32993e0abbd"
        }
      ],
      sortOrder: "NotSorted",
      sortField: "",
      ...
      elementType: "RecordQuery",
      outputReferenceIndex: "88a32528-0dfa-4237-b9dd-a14c1a6d6d10",
      dataType: "SObject",
      isCollection: true,
      subtype: "Account",
      storeOutputAutomatically: true,
    ...
    "2635dcd9-5d1d-4d46-b683-eabd7059690c": {
      ...
      outputReference: "787fd564-24db-448c-ba59-ef88c8a5cbd9",
      ...
      elementType: "RecordQuery",
      outputReferenceIndex: "3c8e62e5-94ba-4bf8-a9cb-6f4599e3020b",
      dataType: "Boolean",
      storeOutputAutomatically: false,
      getFirstRecordOnly: true
    },
    "f35b9254-9177-4813-84c0-92bc3dd1e922": {
      ...
      fieldReferences: [
        {
          fieldReference: "9d11ba05-33c4-4893-87b8-9560be9557d2"
        },
        {
          fieldReference: "2d1ada73-88e9-4cf4-a814-dcba8d517104"
        }
      ],
      elementType: "Screen",
      maxConnections: 1
    ...
    "1283ede6-414b-45a2-851a-1b113f26bffd": {
      ...
      storedValueIndex: "b8c16d53-6fcd-458c-b3e6-51f2658308bc",
