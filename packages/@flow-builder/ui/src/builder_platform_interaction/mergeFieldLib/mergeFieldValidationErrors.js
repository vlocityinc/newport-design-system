...
export function resourceCannotBeUsedAsMergeField(resourceName, startIndex, endIndex) {
...
export function unknownRecordField(entityName, fieldName, startIndex, endIndex) {
    const validationErrorLabel = format(LABELS.unknownRecordField, fieldName, entityName);
    return validationError(VALIDATION_ERROR_TYPE.UNKNOWN_MERGE_FIELD, validationErrorLabel, startIndex, endIndex);
}

export function invalidPolymorphicRecordFieldReference(entityName, polymorphicReference, startIndex, endIndex) {
