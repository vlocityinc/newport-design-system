...
import inputCollectionPlaceholder from '@salesforce/label/FlowBuilderFilterEditor.inputCollectionPlaceholder';
import selectCollection from '@salesforce/label/FlowBuilderFilterEditor.selectCollection';
