        ...
        describe('On typing and blur (LHS/RHS changes)', () => {
            describe('No error', () => {
                it.each`
                    ...
                    ${'{!feedItemVariable}'}                                     | ${'{!feedItemVariable}'}                                     | ${{ iconName: 'utility:record_alt', label: 'feedItemVariable' }}                                                   | ${{ iconName: 'utility:record_alt', label: 'feedItemVariable' }}
                    ...
                    ${'{!apexComplexTypeVariable.acct}'}                         | ${'{!apexComplexTypeVariable.acct}'}                         | ${{ iconName: 'utility:record_alt', label: 'apexComplexTypeVariable > acct' }}                                     | ${{ iconName: 'utility:record_alt', label: 'apexComplexTypeVariable > acct' }}
                    ...
                    ${'{!subflowAutomaticOutput.accountOutput}'}                 | ${'{!subflowAutomaticOutput.accountOutput}'}                 | ${{ iconName: 'utility:record_alt', label: 'Outputs from subflowAutomaticOutput > accountOutput' }}                | ${{ iconName: 'utility:record_alt', label: 'Outputs from subflowAutomaticOutput > accountOutput' }}
                    ...
                    ${'{!lookupRecordAutomaticOutput}'}                          | ${'{!lookupRecordAutomaticOutput}'}                          | ${{ iconName: 'utility:record_alt', label: 'Account from lookupRecordAutomaticOutput' }}                           | ${{ iconName: 'utility:record_alt', label: 'Account from lookupRecordAutomaticOutput' }}
        ...
        describe('On selecting and blur (LHS/RHS changes)', () => {
            describe('No error', () => {
                it.each`
                    ...
                    ${'Outputs from subflowAutomaticOutput.accountOutput'}                 | ${'Outputs from subflowAutomaticOutput.accountOutput'}                 | ${{ iconName: 'utility:record_alt', label: 'Outputs from subflowAutomaticOutput > accountOutput' }}                | ${{ iconName: 'utility:record_alt', label: 'Outputs from subflowAutomaticOutput > accountOutput' }}
                    ...
                    ${'accountSObjectVariable'}                                            | ${'accountSObjectVariable'}                                            | ${{ iconName: 'utility:record_alt', label: 'accountSObjectVariable' }}                                             | ${{ iconName: 'utility:record_alt', label: 'accountSObjectVariable' }}
                    ...
                    ${'Account from lookupRecordAutomaticOutput'}                          | ${'Account from lookupRecordAutomaticOutput'}                          | ${{ iconName: 'utility:record_alt', label: 'Account from lookupRecordAutomaticOutput' }}                           | ${{ iconName: 'utility:record_alt', label: 'Account from lookupRecordAutomaticOutput' }}
