...
import { flowWithCreateRecordUsingSObject, flowWithCreateRecordUsingSObjectCollection, flowWithCreateRecordUsingFields } from 'mock/flows/flowWithCreateRecord';
...
describe('Record Create Editor', () => {
    ...
    describe('Add new element', () => {
        ...
        it('all field should be empty', () => {
            const sObjectOrSObjectCollectionPickerElement = getSObjectOrSObjectCollectionPicker(recordCreateElement);
            return resolveRenderCycles(() => {
    ...
    describe('Existing element', () => {
        ...
        describe('Working with sObject Collection', () => {
            ...
            it('input reference should display The variable "vAccountCollection"', () => {
                const sObjectOrSObjectCollectionPickerElement = getSObjectOrSObjectCollectionPicker(recordCreateElement);
                return resolveRenderCycles(() => {
                    expect(sObjectOrSObjectCollectionPickerElement.value).toBe(recordCreateElement.node.inputReference.value);
                });
            });
            it('sObject Or SObject Collection Picker should contain "New Resource"', () => {
                const rhsGroupedCombobox = getResourceGroupedCombobox(recordCreateElement);
        ...
        describe('Working with fields', () => {
            ...
            it('entity Resource picker should display the entity', () => {
                return resolveRenderCycles(() => {
                    ...
                    expect(entityResourcePicker.value).toBe(recordCreateElement.node.object.value);
                });
            });
