    ...
    describe('Existing flow', () => {
        ...
        describe('Automatic field property editor', () => {
            ...
            describe.each`
                ...
                ${'variable and text field'}                                           | ${'accountSObjectVariable.Name'}                      | ${'Name'}              | ${'Account Name'}        | ${'Text(255)'}             | ${'Account'}                            | ${'FlowBuilderAutomaticFieldEditor.isRequiredTrue'}  | ${'FlowBuilderAutomaticFieldEditor.isCreateableTrue'}  | ${'FlowBuilderAutomaticFieldEditor.isUpdateableTrue'} | ${null}
                ...
                ${'automatic output and text field'}                                   | ${'lookupRecordAutomaticOutput.Name'}                 | ${'Name'}              | ${'Account Name'}        | ${'Text(255)'}             | ${'Account'}                            | ${'FlowBuilderAutomaticFieldEditor.isRequiredTrue'}  | ${'FlowBuilderAutomaticFieldEditor.isCreateableTrue'}  | ${'FlowBuilderAutomaticFieldEditor.isUpdateableTrue'} | ${null}
