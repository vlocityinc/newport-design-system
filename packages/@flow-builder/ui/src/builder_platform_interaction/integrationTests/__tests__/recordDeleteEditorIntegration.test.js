...
import { LIGHTNING_COMPONENTS_SELECTORS, INTERACTION_COMPONENTS_SELECTORS, FLOW_BUILDER_VALIDATION_ERROR_MESSAGES, auraFetch,
    focusoutEvent, blurEvent, textInputEvent, getLabelDescriptionLabelElement, getLabelDescriptionNameElement, expectGroupedComboboxItem, getChildComponent, getEntityResourcePicker} from "../integrationTestUtils";
...
const getRecordVariableRPickerChildGroupedComboboxComponent = parentPickerComponent => {
...
const getEntityResourcePickerChildGroupedComboboxComponent = parentPickerComponent => {
...
const changeComboboxValue = (combobox, newValue) => {
...
const newFilterItem = (lhsValue = '', operatorValue = '', rhsValue = '', rhsDataType = '') => ({
    leftHandSide: {
        value: lhsValue,
        error: null
      },
        ...
        describe('Working with sObject', () => {
            ...
            describe('Record Variable or Record Collection Variable picker', () => {
                ...
                it('Should contain "New Resource" entry', () => {
                    const groupedCombobox = getRecordVariableRPickerChildGroupedComboboxComponent(recordVariablePicker);
                    return Promise.resolve().then(() => {
                ...
                it('Should contain all record variables', () => {
                    const comboboxItems = getRecordVariableRPickerChildGroupedComboboxComponent(recordVariablePicker).items;
