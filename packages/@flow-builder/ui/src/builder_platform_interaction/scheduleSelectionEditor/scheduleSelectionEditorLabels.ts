import defineRecurringSchedule from '@salesforce/label/FlowBuilderStartEditor.defineRecurringSchedule';
import defineRecurringScheduleDesc from '@salesforce/label/FlowBuilderStartEditor.defineRecurringScheduleDesc';
...
import runOnceDesc from '@salesforce/label/FlowBuilderStartEditor.runOnceDesc';
import runOnceOnActivation from '@salesforce/label/FlowBuilderStartEditor.runOnceOnActivation';
import runOnceOnDateTime from '@salesforce/label/FlowBuilderStartEditor.runOnceOnDateTime';
...
export const LABELS = {
    selectScheduleType,
    selectScheduleTypeDesc,
    defineRunOnceSchedule,
    defineRunOnceScheduleDesc,
    runOnceOnDateTime,
    runOnceOnActivation,
    recurring,
    recurringDesc,
