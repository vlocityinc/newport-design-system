...
import completeOptionBasedOnCustomFlow from '@salesforce/label/FlowBuilderStageStepEditor.completeOptionBasedOnCustomFlow';
...
export const LABELS = {
    ...
    exitDeterminationFlowSelectorHeader,
