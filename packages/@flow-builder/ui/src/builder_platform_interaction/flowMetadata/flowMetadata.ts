...
export const ELEMENT_TYPE = {
    ...
    STEPPED_STAGE_WITH_MODIFIED_AND_DELETED_STEPS: 'STEPPED_STAGE_WITH_MODIFIED_AND_DELETED_STEPS',
    STEPPED_STAGE_ITEM: 'STEPPED_STAGE_ITEM',
