/* Labels */
import emptyTimeTriggerLabel from '@salesforce/label/FlowBuilderStartEditor.emptyTimeTriggerLabel';
import timeTriggerListHeader from '@salesforce/label/FlowBuilderStartEditor.timeTriggerListHeader';
