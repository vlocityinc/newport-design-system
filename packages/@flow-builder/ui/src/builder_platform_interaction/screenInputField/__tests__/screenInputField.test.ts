...
describe('Currency screen field', () => {
    ...
    it('Type should be number', async () => {
        await ticks(1);
    ...
    it('Formatter should be set to currency', async () => {
        await ticks(1);
        const input = inputWrapperCmp.shadowRoot.querySelector(SELECTORS.INPUT);
...
describe('Number screen field', () => {
    ...
    it('Formatter should be set to undefined', async () => {
        await ticks(1);
        const input = inputWrapperCmp.shadowRoot.querySelector(SELECTORS.INPUT);
...
describe('Checkbox field with global constant false for its default value', () => {
    ...
    it('Checkbox should not be checked', async () => {
        await ticks(1);
        const input = inputWrapperCmp.shadowRoot.querySelector(SELECTORS.INPUT);
...
describe('Screen input field with no label', () => {
    ...
    it('Label should be shown even when empty because we display a placeholder label', async () => {
        await ticks(1);
        const input = inputWrapperCmp.shadowRoot.querySelector(SELECTORS.INPUT);
        expect(input.variant).toEqual(LIGHTNING_INPUT_VARIANTS.STANDARD);
    });
...
describe('Screen input field with empty space only should not be displayed', () => {
    ...
    it('Label should be hidden when it is empty', async () => {
        await ticks(1);
        const input = inputWrapperCmp.shadowRoot.querySelector(SELECTORS.INPUT);
...
describe('DateTime screen input field', () => {
    ...
    it('Lightning input type should be dateTime', async () => {
        await ticks(1);
        const input = inputWrapperCmp.shadowRoot.querySelector(SELECTORS.INPUT);
        expect(input.type).toEqual(LIGHTNING_INPUT_TYPES.DATE_TIME);
    });
    it('Value should be converted to ISO string format', async () => {
        await ticks(1);
        const input = inputWrapperCmp.shadowRoot.querySelector(SELECTORS.INPUT);
...
describe('DateTime screen input field with default value set to a reference', () => {
    ...
    it('Value should display empty string because it is a merge field', async () => {
        await ticks(1);
        const input = inputWrapperCmp.shadowRoot.querySelector(SELECTORS.INPUT);
...
describe('Date screen input field', () => {
    ...
    it('Lightning input type should be date', async () => {
        await ticks(1);
        const input = inputWrapperCmp.shadowRoot.querySelector(SELECTORS.INPUT);
