...
import { filterAndMapToMenuItems, SortField } from '../fieldInputMenuDataRetrieval';
...
describe('filterAndMapToMenuItems', () => {
    ...
    describe('E2E with Screen flow', () => {
        beforeAll(() => {
            ...
            setProcessTypeFeature(FLOW_PROCESS_TYPE.FLOW, [FLOW_PROCESS_TYPE_FEATURE.GLOBAL_VARIABLES]);
        });
        afterAll(() => {
            Store.resetStore();
            resetGlobalVariables();
