...
import { getSystemVariables, SYSTEM_VARIABLE_PREFIX, SYSTEM_VARIABLE_CLIENT_PREFIX } from "./systemVariables";
...
export const isGlobalConstantOrSystemVariableId = (id) => {
    ...
    return [GLOBAL_CONSTANT_PREFIX, SYSTEM_VARIABLE_PREFIX, SYSTEM_VARIABLE_CLIENT_PREFIX].indexOf(prefix) >= 0;
};
