...
export const loadApexPlugins = () =>
    fetchOnce(SERVER_ACTION_TYPE.GET_APEX_PLUGINS, {}, { background: true });
...
export const loadEntities = crudType =>
    fetchOnce(
        SERVER_ACTION_TYPE.GET_ENTITIES,
        { crudType },
        { disableErrorModal: true }
    ).then(setEntities);
...
export const loadWorkflowEnabledEntities = () =>
    fetchOnce(
        ...
        {},
        { disableErrorModal: true }
    ).then(setWorkflowEnabledEntities);
