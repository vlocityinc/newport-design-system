    ...
    describe('getParameterItemWarning', () => {
        ...
        describe('Duplicates', () => {
            ...
            it('should have a badge and warning message if there is another warning for the same parameter', () => {
                ...
                expect(warning).toEqual({ "shouldBeDeleted": true, "hideIcon" : true, "warningBadge": "FlowBuilderInvocableActionEditor.badgeWillCauseErrors", "warningMessage": "FlowBuilderInvocableActionEditor.warningNotAvailable" });
            });
        });
    });
});