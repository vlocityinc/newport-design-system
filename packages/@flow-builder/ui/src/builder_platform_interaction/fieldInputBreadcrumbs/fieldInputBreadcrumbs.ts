import { FieldInputBreadcrumbClickEvent } from 'builder_platform_interaction/events';
...
export default class FieldInputBreadcrumbs extends LightningElement {
    ...
    private _breadcrumbs: FieldInputBreadcrumb[] = [];

    @track
    truncatedBreadcrumbs: FieldInputBreadcrumb[] = [];
     ...
     */
    @api
    set breadcrumbs(value: FieldInputBreadcrumb[]) {
     ...
     */
    @api
    addBreadcrumb(breadcrumb: FieldInputBreadcrumb) {
     ...
     */
    getViewFromModel(breadcrumbsData: FieldInputBreadcrumb[]) {
     ...
     * @returns all breadcrumbs (truncated and non-truncated)
     */
    get allBreadcrumbs(): FieldInputBreadcrumb[] {
    ...
    handleBreadcrumbClick(event: PointerEvent) {
        ...
        if (breadcrumbId) {
            ...
            this.dispatchEvent(new FieldInputBreadcrumbClickEvent(breadcrumbIndex));
            this.isExpanded = false;
        }
    }
