...
describe('Default Validations', () => {
    describe('Stage Order property', () => {
        it('should return an error if null.', () => {
            expect(stageValidation.validateProperty('stageOrder', null)).toBe(LABELS.shouldBeAPositiveOrNegativeIntegers);
        });
        it('should return an error if NaN or exponential value is entered.', () => {
            expect(stageValidation.validateProperty('stageOrder', 'e4')).toBe(LABELS.shouldBeAPositiveOrNegativeIntegers);
        });
