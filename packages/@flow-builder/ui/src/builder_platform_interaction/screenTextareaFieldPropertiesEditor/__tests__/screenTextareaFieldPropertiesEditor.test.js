...
const SELECTORS = {
    ...
    DEFAULT_VALUE_FIELD:
        'builder_platform_interaction-screen-property-field[type="long_string"]',
    HELP_TEXT:
        'builder_platform_interaction-screen-property-field[name="helpText"]',
    VALIDATION_ERROR_MESSAGE:
        'builder_platform_interaction-resourced-rich-text-editor.errorMessage',
    VALIDATION_FORMULA:
...
describe('screen-textarea-field-properties-editor', () => {
    ...
    it('API Name field should be filled in', () => {
        return Promise.resolve().then(() => {
            const nameAndLabelField = screenTextAreaFieldPropEditor.shadowRoot.querySelector(
    ...
    it('Validation rule error message is present but empty', () => {
        return Promise.resolve().then(() => {
            const validationEditor = screenTextAreaFieldPropEditor.shadowRoot.querySelector(
