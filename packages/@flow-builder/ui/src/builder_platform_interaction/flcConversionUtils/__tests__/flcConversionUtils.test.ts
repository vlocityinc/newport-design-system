...
describe('can convert Free Form Flow with', () => {
    ...
    it('loop degenerate', () => {
        const connectors = [
            ...
            { source: 'loop', target: 'loop', type: 'LOOP_NEXT' },
...
describe('cant convert Free Form Flow with', () => {
    ...
    it('loop with nested decision jumping after loop', () => {
        const connectors = [
