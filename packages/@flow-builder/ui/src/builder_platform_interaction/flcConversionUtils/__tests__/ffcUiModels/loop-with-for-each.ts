export default {
    connectors: [
        ...
        {
            guid: 'loop-for-each-screen-element-guid -> loop-element-guid',
            source: 'loop-for-each-screen-element-guid',
            target: 'loop-element-guid',
            label: null,
            type: 'REGULAR',
            config: { isSelected: false }
        ...
        {
            guid: 'loop-element-guid -> loop-for-each-screen-element-guid',
            source: 'loop-element-guid',
            target: 'loop-for-each-screen-element-guid',
            label: 'LOOP_NEXT',
            type: 'LOOP_NEXT',
            config: { isSelected: false }
        }
    ],
    canvasElements: ['loop-element-guid', 'loop-for-each-screen-element-guid', 'start-element-guid'],
    elements: {
        'start-element-guid': {
