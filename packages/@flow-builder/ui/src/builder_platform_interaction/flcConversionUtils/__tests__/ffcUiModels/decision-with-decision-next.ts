export default {
    connectors: [
        ...
        {
            guid: 'decision-element-guid -> decision-next-element-guid',
            source: 'decision-element-guid',
            target: 'decision-next-element-guid',
            label: 'DEFAULT',
            type: 'DEFAULT',
            config: { isSelected: false }
        }
    ],
    canvasElements: ['decision-element-guid', 'decision-next-element-guid', 'start-element-guid'],
    elements: {
        'start-element-guid': {
