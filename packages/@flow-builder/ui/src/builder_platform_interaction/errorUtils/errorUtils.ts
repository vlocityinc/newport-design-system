...
export const errorTypeMap = {
    ...
    FLOW_SCHEDULED_PATH_CANNOT_USE_IS_CHANGED: errorType.START_ELEMENT_ERROR,
    FLOW_SCHEDULED_PATH_ASYNCAFTERCOMMIT_REQUIRES_RECORD_CHANGED_OR_ISCHANGED: errorType.START_ELEMENT_ERROR,
