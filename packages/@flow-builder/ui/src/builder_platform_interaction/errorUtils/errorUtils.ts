...
export const errorTypeMap = {
    ...
    BEFORE_SAVE_FLOW_RECORD_UPDATE_ALWAYS_HAS_ASSIGNMENTS: errorType.PROPERTY_EDITOR_ERROR,
    TRIGGERING_RECORD_UPDATE_MUST_HAVE_INPUT_FIELD_ASSIGNMENTS: errorType.PROPERTY_EDITOR_ERROR,
