...
export const NUMBER_RECORDS_OPTIONS = {
    ...
    [ELEMENT_TYPE.RECORD_DELETE]: getNumberRecordsOption(LABELS.useIdsStoredToDeleteLabel, LABELS.specifyConditionsToDeleteLabel)
};
...
export const WAY_TO_STORE_FIELDS_OPTIONS = {
    ...
    [ELEMENT_TYPE.RECORD_CREATE]: getWayToStoreOption(LABELS.useAllValuesFromRecordVariableLabel, LABELS.useSeparateVariableLabel),
};
