export const LIGHTNING_COMPONENTS_SELECTORS = {
    ...
    LIGHTNING_POPUP_SOURCE: 'lightning-popup-source',
...
export const INTERACTION_COMPONENTS_SELECTORS = {
    ...
    FIELD_INPUT: 'builder_platform_interaction-field-input',
    FIELD_INPUT_BOX: 'builder_platform_interaction-field-input-box',
    FIELD_INPUT_BOX_PILL: 'builder_platform_interaction-field-input-box-pill',
    FIELD_INPUT_BREADCRUMBS: 'builder_platform_interaction-field-input-breadcrumbs',
    FIELD_INPUT_RICH_HELP_POPUP: 'builder_platform_interaction-field-input-rich-help-popup',
    FIELD_INPUT_MENU: 'builder_platform_interaction-field-input-menu',
    FIELD_INPUT_MENU_SECTION: 'builder_platform_interaction-field-input-menu-section',
    FIELD_INPUT_MENU_SECTION_ITEM: 'builder_platform_interaction-field-input-menu-section-item',
    ...
    SCOPED_NOTIFICATION: 'builder_platform_interaction-scoped-notification',
