...
describe('Text with merge fields mutation', () => {
    ...
    it('Replaces guids by devName for multiple merge fields inside a template', () => {
        expect(mutateTextWithMergeFields(' {!VARIABLE_1.name} {!VARIABLE_2.id}')).toEqual(
            ' {!variable1.name} {!variable2.id}'
        );
    });
    ...
    it('Replaces guid by devName for cross-object field references', () => {
        expect(mutateTextWithMergeFields(' {!VARIABLE_1.objectName1.objectName2.fieldName}')).toEqual(
    ...
    it('Replaces guid by devName for polymorphic relationships in cross-object field references', () => {
        expect(
            mutateTextWithMergeFields(' {!VARIABLE_1.polymorphicObjectName1:specificObjectName2.fieldName}')
        ).toEqual(' {!variable1.polymorphicObjectName1:specificObjectName2.fieldName}');
    });
    it('Properly handle {!{!', () => {
...
describe('Text with merge fields demutation', () => {
    ...
    it('Replaces devNames by guids for multiple merge fields inside a template', () => {
        expect(demutateTextWithMergeFields(' {!variable1.a} {!variable2.a}')).toEqual(
            ' {!VARIABLE_1.a} {!VARIABLE_2.a}'
        );
    });
    it('Ignores unknown elements for merge fields', () => {
    ...
    it('Replaces devName by guid for cross-object field references', () => {
        expect(demutateTextWithMergeFields(' {!variable1.objectName1.objectName2.fieldName}')).toEqual(
    ...
    it('Replaces devName by guid for polymorphic relationships in cross-object field references', () => {
        expect(
            demutateTextWithMergeFields(' {!variable1.polymorphicObjectName1:specificObjectName2.fieldName}')
        ).toEqual(' {!VARIABLE_1.polymorphicObjectName1:specificObjectName2.fieldName}');
    });
});
