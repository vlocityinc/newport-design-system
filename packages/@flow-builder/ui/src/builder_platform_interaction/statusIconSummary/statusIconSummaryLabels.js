...
import popupWarningMessageSingular from "@salesforce/label/FlowBuilderCommonPropertyEditor.popupWarningMessageSingular";
import popupWarningMessagePlural from "@salesforce/label/FlowBuilderCommonPropertyEditor.popupWarningMessagePlural";
export const LABELS = {
    popupErrorMessageSingular,
    popupErrorMessagePlural,
    closePanelButtonTitle,
    popupWarningMessageSingular,
    popupWarningMessagePlural
};