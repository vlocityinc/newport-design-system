...
const getFeaturedProcessTypesWithIconsWithProcessTypes = getProcessTypesWithIconsWithProcessTypes.bind(
    null,
    PROCESS_TYPES_ICONS.FEATURED
);
const getOtherProcessTypesWithIconsWithProcessTypes = getProcessTypesWithIconsWithProcessTypes.bind(
    null,
