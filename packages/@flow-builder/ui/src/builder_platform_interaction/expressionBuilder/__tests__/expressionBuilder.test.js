...
import { numberVariableGuid, numberVariableDevName, stringVariableGuid, stringVariableDevName,
    dateVariableGuid, currencyVariableGuid, assignmentElementGuid, elements } from "mock/storeData";
import { getLHSTypes, getOperators, getRHSTypes, RULE_OPERATOR } from "builder_platform_interaction/ruleLib";
import { normalizeLHS, EXPRESSION_PROPERTY_TYPE, getElementsForMenuData, OPERATOR_DISPLAY_OPTION } from "builder_platform_interaction/expressionUtils";
import { ELEMENT_TYPE } from "builder_platform_interaction/flowMetadata";
import { mockAccountFields } from "mock/serverEntityData";
import { FLOW_DATA_TYPE, FEROV_DATA_TYPE, getDataTypeIcons } from "builder_platform_interaction/dataTypeLib";
...
jest.mock('builder_platform_interaction/expressionUtils', () => {
    return {
        ...
        normalizeLHS: jest.fn().mockImplementation(require.requireActual('builder_platform_interaction/expressionUtils').normalizeLHS),
        normalizeRHS: require.requireActual('builder_platform_interaction/expressionUtils').normalizeRHS,
        retrieveRHSVal: require.requireActual('builder_platform_interaction/expressionUtils').retrieveRHSVal,
