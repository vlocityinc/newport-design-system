export const publish = jest.fn().mockImplementation(() => {});
...
export const showPrompt = jest.fn().mockImplementation(() => {});

export const showPrompt2 = jest.fn().mockImplementation(() => {});

export const getCSPTrustedSites = jest.fn().mockImplementation(() => {
    return Promise.resolve(['https://trustedSite.com']);
});

export const canDisplayJustOnce = jest.fn().mockImplementation(() => Promise.resolve(true));
export const canDisplayMultipleTimes = jest.fn().mockImplementation(() => Promise.resolve(true));
export const airgapify = jest.fn((url) => url);
