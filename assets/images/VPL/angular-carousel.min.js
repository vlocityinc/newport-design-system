      ...
      return {
        ...
        link: function(b, c, d) {
          ...
          b.$watch('carouselIndex', f),
            d.hasOwnProperty('rnCarouselPauseOnHover') &&
              'false' !== d.rnCarouselPauseOnHover &&
              (c.on('mouseenter', e), c.on('mouseleave', f)),
      ...
      .service('DeviceCapabilities', function() {
        function a() {
          var a = 'transform',
            b = 'webkitTransform';
          return (
            'undefined' != typeof document.body.style[a]
              ? ['webkit', 'moz', 'o', 'ms'].every(function(b) {
                  var c = '-' + b + '-transform';
                  return 'undefined' != typeof document.body.style[c]
                    ? ((a = c), !1)
                    : !0;
                })
              : (a =
              ...
              return (
                [
                  ...
                  if (angular.isDefined(b)) {
                    ...
                    if (((o = c[1]), (p = c[2]), o))
                      return (
                        angular.isDefined(n.rnCarouselBuffered) &&
                          ((t = !0),
                          (b.value =
                            o +
                            ' in ' +
                ...
                function(m, o, q, r) {
                  ...
                  function C(a, b) {
                    return T || P.length <= 1
                      ? void 0
                      : (z(),
                        (R = o[0].querySelector('li').getBoundingClientRect()
                          .left),
                        (H = !0),
                        (I = a.x),
                        !1);
                    ...
                    if (
                      ...
                      if (((N += 100 * -J / Q), L.isSequential)) {
                        var e = L.moveTreshold * Q,
                          ...
                          h = Math.abs(f) > e;
                        P &&
                          g + m.carouselIndex >= P.length &&
                          (g = P.length - 1 - m.carouselIndex),
                          g + m.carouselIndex < 0 && (g = -m.carouselIndex);
                        var i = h ? g : 0;
                        (J = m.carouselIndex + i),
                          x(J),
                          void 0 !== q.rnCarouselOnInfiniteScrollRight &&
                            0 === g &&
                            0 !== m.carouselIndex &&
                            (d(q.rnCarouselOnInfiniteScrollRight)(m), x(0)),
                          void 0 !== q.rnCarouselOnInfiniteScrollLeft &&
                            0 === g &&
                            0 === m.carouselIndex &&
                            0 === i &&
                            (d(q.rnCarouselOnInfiniteScrollLeft)(m),
                            x(P.length));
                      } else
                        m.$apply(function() {
                  ...
                  function F() {
                    ...
                    t
                      ? ((a =
                          m.carouselIndex <= b
                            ? 0
                            : P && P.length < m.carouselBufferSize
                              ? 0
                              : P &&
                                m.carouselIndex >
                                  P.length - m.carouselBufferSize
                                ? P.length - m.carouselBufferSize
                                : m.carouselIndex - b),
                  ...
                  var H,
                    ...
                    K = {
                      ...
                      transitionDuration:
                        parseInt(q.rnCarouselDuration, 10) || 300,
                      isSequential: !0,
                      autoSlideDuration: 3,
                      bufferSize: 5,
                      moveTreshold: 0.1,
                  ...
                  if (
                    ...
                    var V =
                        (s ? m.$eval(p.replace('::', '')).length : P.length) > 1
                          ? angular.isDefined(n.rnCarouselControlsAllowLoop)
                          : !1,
                      W = s
                        ? '(' + p.replace('::', '') + ').length - 1'
                        : P.length - 1,
                  ...
                  if (void 0 !== q.rnCarouselAutoSlide) {
                    var Y =
                      parseInt(q.rnCarouselAutoSlide, 10) ||
                      L.autoSlideDuration;
                    m.autoSlide = function() {
                      m.autoSlider &&
                        (g.cancel(m.autoSlider), (m.autoSlider = null)),
                  ...
                  if (q.rnCarouselIndex) {
                    ...
                    angular.isFunction(_.assign)
                      ? (m.$watch('carouselIndex', function(a) {
                          $(a);
                        }),
                        m.$parent.$watch(_, function(a, b) {
                          void 0 !== a &&
                            null !== a &&
                            (P && P.length > 0 && a >= P.length
                              ? ((a = P.length - 1), $(a))
                              : P && 0 > a && ((a = 0), $(a)),
                            T || x(a, { animate: !U }),
                            (U = !1));
                        ...
                        (M = !0),
                        L.defaultIndex && x(L.defaultIndex, { animate: !U }))
                      : isNaN(q.rnCarouselIndex) ||
                        x(parseInt(q.rnCarouselIndex, 10), { animate: !1 });
                  } else x(L.defaultIndex, { animate: !U }), (U = !1);
                  if (
                    (q.rnCarouselLocked &&
                      m.$watch(q.rnCarouselLocked, function(a, b) {
                        T = a === !0 ? !0 : !1;
                      }),
                    s)
                  ) {
                    var aa = void 0 !== q.rnCarouselDeepWatch;
                    m[aa ? '$watch' : '$watchCollection'](
                      p,
                      function(a, b) {
                        if (((P = a), !angular.isArray(P)))
          ...
          var b = (function() {
            ...
            function i(a, b, c, d, e, g, i, j, k) {
              (s = b + c),
                ...
                (v = c - (s - t)),
                a.isPlaying() && !u
                  ? ((a._scheduleId = k(a._timeoutHandler, p)),
                    h(a, 'beforeTween'),
                    f(t, d, e, g, c, b, i),
                    h(a, 'afterTween'),
                    j(d, a._attachment, v))
                  : u && (j(g, a._attachment, v), a.stop(!0));
            }
            function j(a, b) {
              var d = {};
              return (
              ...
              (k.prototype.stop = function(c) {
                return (
                  ...
                  (a.cancelAnimationFrame ||
                    ...
                    a.clearTimeout)(this._scheduleId),
                  c &&
          ...
          !(function() {
            ...
            (function(a) {
              ...
              function t(b, c) {
                a.each(c, function(a) {
                  for (
                    var d = c[a], e = d.chunkNames, f = e.length, g = '', h = 0;
                    f > h;
                    h++
                  )
